<template lang="html">
  <div class="">
    <div class="container scrollspy" id="project-manager">
      <div class="section">
        <div class="row">
          <div class="col s12 center">
            ...
            <p class="left-align light">3. Diseño y prototipo: Se inicia con el wireframe del sitio web lo cual trae muchas preguntas de organización y presentación. También se revisan layouts y diseños.</p>
            <p class="left-align light">4. Construcción y Testing: Implementación del CMS que mejor se ajuste a las necesidades del sitio. Etapa de evaluación.</p>
            <p class="left-align light">5. Despliegue y Evaluación: Implementación de estrategias de social marketing, definición de métricas, objetivos y analítica.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="parallax-container valign-wrapper">
      ...
      <div class="parallax"><img src="imgs/thing.jpg" alt="Unsplashed background img 2"></div>
    </div>
